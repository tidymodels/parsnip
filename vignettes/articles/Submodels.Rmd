...
description: |
  This vignette describes how you can use `multi_predict()` to evaluating
  submodels with the same model object such that you avoid having to fit
  any of the submodels.
vignette: >
