---
title: "Minimal Examples for Fitting and Predicting"
vignette: >
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteIndexEntry{Minimal Examples for Fitting and Predicting}
output:
  knitr:::html_vignette
---
...
This is a collection of minimal examples for fitting and predicting with various models and engines. 
...
<details> <summary>`rand_forest()` with the `"ranger"` engine</summary>
...
<details> <summary>`rand_forest()` with the `"randomForest"` engine</summary>
...
<details> <summary>`svm_linear()` with the `"LiblineaR"` engine</summary>
...
<details> <summary>`svm_linear()` with the `"kernlab"` engine</summary>
...
<details> <summary>`svm_poly()` with the `"kernlab"` engine</summary>
...
<details> <summary>`svm_rbf()` with the `"kernlab"` engine</summary>
