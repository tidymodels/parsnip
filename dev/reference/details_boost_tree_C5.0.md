...
creates a series of classification trees forming an ensemble. Each tree
...
is a wrapper around
[`C50::C5.0()`](https://topepo.github.io/C5.0/reference/C5.0.html) that
...
Also, it is unlikely that early stopping will occur if
`sample_size = 1`.
