...
- `rbf_sigma`: Radial Basis Function sigma (type: double, default: see
  below)
...
[`kernlab::sigest()`](https://rdrr.io/pkg/kernlab/man/sigest.html). This
method uses random numbers so, without setting the seed before fitting,
the model will not be reproducible.
