...
- [`nnet`](https://parsnip.tidymodels.org/dev/reference/details_multinom_reg_nnet.md)`¹`

- [`brulee`](https://parsnip.tidymodels.org/dev/reference/details_multinom_reg_brulee.md)

- [`glmnet`](https://parsnip.tidymodels.org/dev/reference/details_multinom_reg_glmnet.md)

- [`h2o`](https://parsnip.tidymodels.org/dev/reference/details_multinom_reg_h2o.md)`²`
...
[`nnet engine details`](https://parsnip.tidymodels.org/dev/reference/details_multinom_reg_nnet.md),
[`brulee engine details`](https://parsnip.tidymodels.org/dev/reference/details_multinom_reg_brulee.md),
