...
`aorsf::orsf()` fits a model that creates a large number of oblique
decision trees, each de-correlated from the others. The final prediction
...
### Prediction types
    ...
    ## 7 censored regression survival
...
(see
[tidymodels/bonsai#78](https://github.com/tidymodels/bonsai/pull/78)).
