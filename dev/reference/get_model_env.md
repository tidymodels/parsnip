...
#> [145] "null_model_predict"           "ordinal_reg"                 
#> [147] "ordinal_reg_args"             "ordinal_reg_fit"             
#> [149] "ordinal_reg_modes"            "ordinal_reg_pkgs"            
#> [151] "ordinal_reg_predict"          "pls"                         
#> [153] "pls_args"                     "pls_fit"                     
#> [155] "pls_modes"                    "pls_pkgs"                    
#> [157] "pls_predict"                  "poisson_reg"                 
#> [159] "poisson_reg_args"             "poisson_reg_fit"             
#> [161] "poisson_reg_modes"            "poisson_reg_pkgs"            
#> [163] "poisson_reg_predict"          "proportional_hazards"        
#> [165] "proportional_hazards_args"    "proportional_hazards_fit"    
#> [167] "proportional_hazards_modes"   "proportional_hazards_pkgs"   
#> [169] "proportional_hazards_predict" "rand_forest"                 
#> [171] "rand_forest_args"             "rand_forest_encoding"        
#> [173] "rand_forest_fit"              "rand_forest_modes"           
#> [175] "rand_forest_pkgs"             "rand_forest_predict"         
#> [177] "rule_fit"                     "rule_fit_args"               
#> [179] "rule_fit_fit"                 "rule_fit_modes"              
#> [181] "rule_fit_pkgs"                "rule_fit_predict"            
#> [183] "surv_reg"                     "surv_reg_args"               
#> [185] "surv_reg_encoding"            "surv_reg_fit"                
#> [187] "surv_reg_modes"               "surv_reg_pkgs"               
#> [189] "surv_reg_predict"             "survival_reg"                
#> [191] "survival_reg_args"            "survival_reg_fit"            
#> [193] "survival_reg_modes"           "survival_reg_pkgs"           
#> [195] "survival_reg_predict"         "svm_linear"                  
#> [197] "svm_linear_args"              "svm_linear_encoding"         
#> [199] "svm_linear_fit"               "svm_linear_modes"            
#> [201] "svm_linear_pkgs"              "svm_linear_predict"          
#> [203] "svm_poly"                     "svm_poly_args"               
#> [205] "svm_poly_encoding"            "svm_poly_fit"                
#> [207] "svm_poly_modes"               "svm_poly_pkgs"               
#> [209] "svm_poly_predict"             "svm_rbf"                     
#> [211] "svm_rbf_args"                 "svm_rbf_encoding"            
#> [213] "svm_rbf_fit"                  "svm_rbf_modes"               
#> [215] "svm_rbf_pkgs"                 "svm_rbf_predict"             
#> [217] "tabular_auto_int"             "tabular_auto_int_args"       
#> [219] "tabular_auto_int_fit"         "tabular_auto_int_modes"      
#> [221] "tabular_auto_int_pkgs"        "tabular_auto_int_predict"    
#> [223] "tabular_chronos"              "tabular_chronos_args"        
#> [225] "tabular_chronos_fit"          "tabular_chronos_modes"       
#> [227] "tabular_chronos_pkgs"         "tabular_chronos_predict"     
#> [229] "tabular_icl"                  "tabular_icl_args"            
#> [231] "tabular_icl_fit"              "tabular_icl_modes"           
#> [233] "tabular_icl_pkgs"             "tabular_icl_predict"         
#> [235] "tabular_pfn"                  "tabular_pfn_args"            
#> [237] "tabular_pfn_fit"              "tabular_pfn_modes"           
#> [239] "tabular_pfn_pkgs"             "tabular_pfn_predict"         
#> [241] "tabular_resnet"               "tabular_resnet_args"         
#> [243] "tabular_resnet_fit"           "tabular_resnet_modes"        
#> [245] "tabular_resnet_pkgs"          "tabular_resnet_predict"      
#> [247] "tabular_rln"                  "tabular_rln_args"            
#> [249] "tabular_rln_fit"              "tabular_rln_modes"           
#> [251] "tabular_rln_pkgs"             "tabular_rln_predict"         
#> [253] "tabular_saint"                "tabular_saint_args"          
#> [255] "tabular_saint_fit"            "tabular_saint_modes"         
#> [257] "tabular_saint_pkgs"           "tabular_saint_predict"       
```
