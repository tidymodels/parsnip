...
`brulee::brulee_mlp_two_layer()` fits a neural network (with version
0.3.0.9000 or higher of brulee)
...
- `hidden_layer_2` and `activation_2` control the format of the second
  layer.
