...
- [`kernlab`](https://parsnip.tidymodels.org/dev/reference/details_svm_poly_kernlab.md)`¹`
...
[`kernlab engine details`](https://parsnip.tidymodels.org/dev/reference/details_svm_poly_kernlab.md)
