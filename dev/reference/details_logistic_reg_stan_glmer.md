...
The `"stan_glmer"` engine estimates hierarchical regression parameters
...
For prediction, the `"stan_glmer"` engine can compute posterior
...
- Sorensen, T, Vasishth, S. 2016. Bayesian linear mixed models using
