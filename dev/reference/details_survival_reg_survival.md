...
In the translated syntax above, note that `model = TRUE` is needed to
...
The allows the model scale parameter to differ between groups contained
in the function. The column used inside
