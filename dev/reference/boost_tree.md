...
- [`catboost`](https://parsnip.tidymodels.org/dev/reference/details_boost_tree_catboost.md)`²`
...
[`catboost engine details`](https://parsnip.tidymodels.org/dev/reference/details_boost_tree_catboost.md),
