...
- `predictor_prop`: Proportion of Predictors (type: double, default: see
  below)
...
In this case, `plsmod::pls_fit()` has the same role as above but
eventually targets `mixOmics::plsda()` or `mixOmics::splsda()`.
