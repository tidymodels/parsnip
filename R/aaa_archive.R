      ...
      "proportional_hazards", "censored regression",         "survival",      "censored",
       ...
       "discrim_regularized",      "classification",             "klaR",       "discrim",
          ...
          "nearest_neighbor",      "classification",             "kknn",              NA,
             ...
             "decision_tree",  "ordinal regression",       "rpartScore",       "ordered",
               "ordinal_reg",  "ordinal regression",             "polr",       "ordered",
               "ordinal_reg",  "ordinal regression",       "ordinalNet",       "ordered",
               "ordinal_reg",  "ordinal regression",             "vglm",       "ordered",
               "ordinal_reg",  "ordinal regression",             "vgam",       "ordered",
               "rand_forest",  "ordinal regression",    "ordinalForest",       "ordered",
