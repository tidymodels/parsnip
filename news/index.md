...
- [`surv_reg()`](https://parsnip.tidymodels.org/reference/surv_reg.md)
...
- [`mlp()`](https://parsnip.tidymodels.org/reference/mlp.md) with
  `keras` engine now work for all activation functions currently
  supported by `keras`
  ([\#1127](https://github.com/tidymodels/parsnip/issues/1127)).

- [`mlp()`](https://parsnip.tidymodels.org/reference/mlp.md) now has a
...
- Ensure that
  [`knit_engine_docs()`](https://parsnip.tidymodels.org/reference/knit_engine_docs.md)
...
- [`.organize_glmnet_pred()`](https://parsnip.tidymodels.org/reference/glmnet_helpers_prediction.md)
...
- An internal method for generating inverse probability of censoring
  ...
  [`.censoring_weights_graf()`](https://parsnip.tidymodels.org/reference/censoring_weights.md).
...
- Transitioned all soft-deprecations that were at least a year old to
  ...
  [`fit_control()`](https://parsnip.tidymodels.org/reference/fit_control.md),
  [`surv_reg()`](https://parsnip.tidymodels.org/reference/surv_reg.md),
  [`varying()`](https://parsnip.tidymodels.org/reference/varying.md),
...
- The `num_leaves` argument of
  [`boost_tree()`](https://parsnip.tidymodels.org/reference/boost_tree.md)s
...
- Enabled passing additional engine arguments with the xgboost
  ...
  Read more in
  [`?details_boost_tree_xgboost`](https://parsnip.tidymodels.org/reference/details_boost_tree_xgboost.md)
...
- Refactored internals of model specification printing functions. These
  ...
  [`print_model_spec()`](https://parsnip.tidymodels.org/reference/add_on_exports.md)
...
- Exported
  [`xgb_predict()`](https://parsnip.tidymodels.org/reference/xgb_train.md)
...
- Bayesian additive regression trees (BART) were added via the
  [`bart()`](https://parsnip.tidymodels.org/reference/bart.md) function.
...
- [`varying()`](https://parsnip.tidymodels.org/reference/varying.md) is
...
- The helper functions
  [`.convert_form_to_xy_fit()`](https://parsnip.tidymodels.org/reference/convert_helpers.md),
  [`.convert_form_to_xy_new()`](https://parsnip.tidymodels.org/reference/convert_helpers.md),
  [`.convert_xy_to_form_fit()`](https://parsnip.tidymodels.org/reference/convert_helpers.md),
  and
  [`.convert_xy_to_form_new()`](https://parsnip.tidymodels.org/reference/convert_helpers.md)
...
- The `liquidSVM` engine for
  [`svm_rbf()`](https://parsnip.tidymodels.org/reference/svm_rbf.md) was
  deprecated due to that package’s removal from CRAN.
...
- The method that `parsnip` stores the model information has changed.
  ...
  [`?get_model_env`](https://parsnip.tidymodels.org/reference/get_model_env.md)
