...
For _pure ridge regression models_, it is advisable to pass `lambda.min.ratio = 0` as an engine argument so that the correct parameter estimates are obtained (see [issue #431](https://github.com/tidymodels/parsnip/issues/431)).
