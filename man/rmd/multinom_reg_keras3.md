...
[keras3_mlp()] is a parsnip wrapper around keras3 code for neural networks. This model fits a multinomial regression as a network with a single hidden unit. 
...
The "Fitting and Predicting with parsnip" [article](https://www.tidymodels.org/learn/models/parsnip-predictions/) contains examples for `multinom_reg()` with the `"keras3"` engine.
