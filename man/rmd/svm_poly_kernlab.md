...
``` r
parsnip:::get_from_env("svm_poly_predict") |>
...
The "Fitting and Predicting with parsnip" [article](https://www.tidymodels.org/learn/models/parsnip-predictions/) contains examples for `svm_poly()` with the `"kernlab"` engine.
