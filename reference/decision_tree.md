...
- [`rpart`](https://parsnip.tidymodels.org/reference/details_decision_tree_rpart.md)`¹²`

- [`C5.0`](https://parsnip.tidymodels.org/reference/details_decision_tree_C5.0.md)

- [`partykit`](https://parsnip.tidymodels.org/reference/details_decision_tree_partykit.md)`²`

- [`rpartScore`](https://parsnip.tidymodels.org/reference/details_decision_tree_rpartScore.md)`²`

- [`spark`](https://parsnip.tidymodels.org/reference/details_decision_tree_spark.md)
...
[`rpart engine details`](https://parsnip.tidymodels.org/reference/details_decision_tree_rpart.md),
[`C5.0 engine details`](https://parsnip.tidymodels.org/reference/details_decision_tree_C5.0.md),
[`partykit engine details`](https://parsnip.tidymodels.org/reference/details_decision_tree_partykit.md),
[`rpartScore engine details`](https://parsnip.tidymodels.org/reference/details_decision_tree_rpartScore.md),
[`spark engine details`](https://parsnip.tidymodels.org/reference/details_decision_tree_spark.md)
