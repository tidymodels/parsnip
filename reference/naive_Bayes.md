...
- [`klaR`](https://parsnip.tidymodels.org/reference/details_naive_Bayes_klaR.md)`¹²`

- [`h2o`](https://parsnip.tidymodels.org/reference/details_naive_Bayes_h2o.md)`²`

- [`naivebayes`](https://parsnip.tidymodels.org/reference/details_naive_Bayes_naivebayes.md)`²`
...
[`klaR engine details`](https://parsnip.tidymodels.org/reference/details_naive_Bayes_klaR.md),
[`h2o engine details`](https://parsnip.tidymodels.org/reference/details_naive_Bayes_h2o.md),
[`naivebayes engine details`](https://parsnip.tidymodels.org/reference/details_naive_Bayes_naivebayes.md)
