...
models](https://parsnip.tidymodels.org/reference/gen_additive_mod.md) in
R, defines a function [`s()`](https://rdrr.io/pkg/mgcv/man/s.html) to be
in-lined into formulas. It can be used like so:
...
parsnip "mgcv"
engine](https://parsnip.tidymodels.org/reference/details_gen_additive_mod_mgcv.md)
looks like:
