...
[fit()](https://parsnip.tidymodels.org/reference/fit.md) or
[fit_xy](https://parsnip.tidymodels.org/reference/fit.md), have class
`model_fit`, and contain the original `model_spec` objects inside them.
See [?model_fit](https://parsnip.tidymodels.org/reference/model_fit.md)
...
[`fit.model_spec()`](https://parsnip.tidymodels.org/reference/fit.md) or
