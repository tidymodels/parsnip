...
- [`MASS`](https://parsnip.tidymodels.org/reference/details_discrim_quad_MASS.md)`¹²`

- [`sparsediscrim`](https://parsnip.tidymodels.org/reference/details_discrim_quad_sparsediscrim.md)`²`
...
[`MASS engine details`](https://parsnip.tidymodels.org/reference/details_discrim_quad_MASS.md),
[`sparsediscrim engine details`](https://parsnip.tidymodels.org/reference/details_discrim_quad_sparsediscrim.md)
