...
- [`kknn`](https://parsnip.tidymodels.org/reference/details_nearest_neighbor_kknn.md)`¹`
...
[`kknn engine details`](https://parsnip.tidymodels.org/reference/details_nearest_neighbor_kknn.md)
