...
- [`glm`](https://parsnip.tidymodels.org/reference/details_logistic_reg_glm.md)`¹`

- [`brulee`](https://parsnip.tidymodels.org/reference/details_logistic_reg_brulee.md)

- [`gee`](https://parsnip.tidymodels.org/reference/details_logistic_reg_gee.md)`²`

- [`glmer`](https://parsnip.tidymodels.org/reference/details_logistic_reg_glmer.md)`²`

- [`glmnet`](https://parsnip.tidymodels.org/reference/details_logistic_reg_glmnet.md)

- [`h2o`](https://parsnip.tidymodels.org/reference/details_logistic_reg_h2o.md)`²`

- [`keras`](https://parsnip.tidymodels.org/reference/details_logistic_reg_keras.md)

- [`LiblineaR`](https://parsnip.tidymodels.org/reference/details_logistic_reg_LiblineaR.md)

- [`spark`](https://parsnip.tidymodels.org/reference/details_logistic_reg_spark.md)

- [`stan`](https://parsnip.tidymodels.org/reference/details_logistic_reg_stan.md)

- [`stan_glmer`](https://parsnip.tidymodels.org/reference/details_logistic_reg_stan_glmer.md)`²`
...
[`glm engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_glm.md),
[`brulee engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_brulee.md),
[`gee engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_gee.md),
[`glmer engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_glmer.md),
[`glmnet engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_glmnet.md),
[`h2o engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_h2o.md),
[`keras engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_keras.md),
[`LiblineaR engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_LiblineaR.md),
[`spark engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_spark.md),
[`stan engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_stan.md),
[`stan_glmer engine details`](https://parsnip.tidymodels.org/reference/details_logistic_reg_stan_glmer.md)
