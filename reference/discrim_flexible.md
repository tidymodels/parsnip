...
`discrim_flexible()` defines a model that fits a discriminant analysis
model that can use nonlinear features created using multivariate
...
- [`earth`](https://parsnip.tidymodels.org/reference/details_discrim_flexible_earth.md)`¹²`
...
[`earth engine details`](https://parsnip.tidymodels.org/reference/details_discrim_flexible_earth.md)
