...
test_that('svm poly raw classification output', {
  ...
  kern_raw <-
    structure(
      list(
        .decision_setosa = c(-1.7938088695119926985200, 1.0625214185831244328995, 0.3823300859367214643569),
        .decision_versicolor = c(-1.481864199067975507162, 0.965571713317597501991, 1.216915825521836413969),
        .decision_virginica = c(0.5042163903735015217933, -1.1640234770560717869614, 3.7827641413457531172071)),
      row.names = c(NA,-3L),
      class = c("tbl_df", "tbl", "data.frame"))
